      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            leading: ClipRRect(
              ...
              child: widget.post.imageUser!= null ? CachedNetworkImage(
                height: 40,
                width: 40,
                imageUrl: widget.post.imageUser!, imageBuilder: (context, imageProvider) => Container(
                ...
                placeholder: (context, url) => const Image(image: AssetImage("assets/images/userdefault.png")),
                errorWidget: (context, url, error) => Icon(Icons.error),

              ) : const Image(image: AssetImage("assets/images/userdefault.png"), height: 40,),
            ),
          ...
          Container(
            ...
            child: Text(widget.post.caption, style: TextStyle(fontSize: 17,color: Colors.black,fontWeight: FontWeight.bold),),
          )
        ],
      ),
    );
