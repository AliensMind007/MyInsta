...
import 'package:svoyinsta/models/user_model.dart' as model;
...
import 'package:svoyinsta/services/pref_service.dart';
import 'package:svoyinsta/services/utils_service.dart';
import 'package:svoyinsta/widgets/buttons.dart';
import 'package:svoyinsta/widgets/textfield.dart';
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        // #app_name
                        Text("MyInsta", style: TextStyle(color: Colors.white, fontSize: 45, fontFamily: ThemeService.fontHeader),),
                        SizedBox(height: 20,),
